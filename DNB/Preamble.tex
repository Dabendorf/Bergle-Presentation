...
% That document is the main document of the presentation which needs to be compiled
% The rest is happening in Presentation.tex
...
% Insert the data of the presentation appearing on the first page
\author[ls]{Lukas Schramm}
\title[bergle]{Bergle - Et konsept av Lukas}
\subtitle{How to develop a game which offends all bergenser on earth}
\institute{\sout{Sbanken} DNB Fagdag}
\date[05.06.24]{5 Juni 2024}
